...
var nonEmptyStringSchema = import_zod2.z.string();
...
var timestampSchema = import_zod2.z.number();
...
var pluginJsonResponseSchema = import_zod2.z.union([
  import_zod2.z.object({
    ...
    render: import_zod2.z.union([
      import_zod2.z.literal("none"),
      import_zod2.z.literal("table"),
...
var pluginResponseEncodingSchema = import_zod2.z.union([
  import_zod2.z.literal("none"),
  import_zod2.z.literal("json"),
  import_zod2.z.literal("application/json")
]);
...
var publicKeyHashSchema = import_zod2.z.string();
var sha256Schema = import_zod2.z.string();
...
var tzKtConfigPostgresqlPortSchema = import_zod2.z.number();
var tzKtConfigApiPortSchema = import_zod2.z.number();
...
var provisionerIDSchema = import_zod2.z.string();
...
var humanLanguageSchema = import_zod2.z.union([import_zod2.z.literal("en"), import_zod2.z.literal("fr")]);
var configContractsDirSchema = import_zod2.z.string();
var configArtifactsDirSchema = import_zod2.z.string();
var currencyAmountV2Schema = import_zod2.z.object({
  amount: import_zod2.z.string(),
  units: import_zod2.z.string()
});
var versionV2Schema = import_zod2.z.string();

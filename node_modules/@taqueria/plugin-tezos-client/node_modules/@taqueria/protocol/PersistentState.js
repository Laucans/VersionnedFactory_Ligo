...
var nonEmptyStringSchema = import_zod3.z.string();
...
var timestampSchema = import_zod3.z.number();
...
var pluginJsonResponseSchema = import_zod3.z.union([
  import_zod3.z.object({
    ...
    render: import_zod3.z.union([
      import_zod3.z.literal("none"),
      import_zod3.z.literal("table"),
...
var pluginResponseEncodingSchema = import_zod3.z.union([
  import_zod3.z.literal("none"),
  import_zod3.z.literal("json"),
  import_zod3.z.literal("application/json")
]);
...
var publicKeyHashSchema = import_zod3.z.string();
var sha256Schema = import_zod3.z.string();
...
var tzKtConfigPostgresqlPortSchema = import_zod3.z.number();
var tzKtConfigApiPortSchema = import_zod3.z.number();
...
var provisionerIDSchema = import_zod3.z.string();
...
var humanLanguageSchema = import_zod3.z.union([import_zod3.z.literal("en"), import_zod3.z.literal("fr")]);
var configContractsDirSchema = import_zod3.z.string();
var configArtifactsDirSchema = import_zod3.z.string();
var currencyAmountV2Schema = import_zod3.z.object({
  amount: import_zod3.z.string(),
  units: import_zod3.z.string()
});
var versionV2Schema = import_zod3.z.string();

...
export declare const schemas: {
    rawSchema: import("zod").ZodUnion<[import("zod").ZodLiteral<"none">, import("zod").ZodLiteral<"json">, import("zod").ZodLiteral<"application/json">]>;
    schema: import("zod").ZodEffects<import("zod").ZodUnion<[import("zod").ZodLiteral<"none">, import("zod").ZodLiteral<"json">, import("zod").ZodLiteral<"application/json">]>, ({
        __type: PluginResponseEncodingStrict;
    } & "none") | ({
        __type: PluginResponseEncodingStrict;
    } & "json") | ({
        __type: PluginResponseEncodingStrict;
    } & "application/json"), "none" | "json" | "application/json">;
};
export declare const rawSchema: import("zod").ZodUnion<[import("zod").ZodLiteral<"none">, import("zod").ZodLiteral<"json">, import("zod").ZodLiteral<"application/json">]>;
export declare const internalSchema: import("zod").ZodUnion<[import("zod").ZodLiteral<"none">, import("zod").ZodLiteral<"json">, import("zod").ZodLiteral<"application/json">]>;
